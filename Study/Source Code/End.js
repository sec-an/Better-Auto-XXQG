...
function init(){
    ...
    threads.start(function () {
        try{
            var x = http.get('https://git.yumenaka.net/https://raw.githubusercontent.com/Twelve-blog/Study_hamibot/main/replace.js').body.string();
